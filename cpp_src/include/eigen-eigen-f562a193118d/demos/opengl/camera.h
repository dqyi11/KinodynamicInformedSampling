...
public:
    ...
    inline uint vpX(void) const
    {
        return mVpX;
    }
    inline uint vpY(void) const
    {
        return mVpY;
    }
    inline uint vpWidth(void) const
    {
        return mVpWidth;
    }
    inline uint vpHeight(void) const
    {
        return mVpHeight;
    }

    inline float fovY(void) const
    {
        return mFovY;
    }
    ...
    inline const Eigen::Vector3f &position(void) const
    {
    ...
    inline const Eigen::Vector3f &target(void)
    {
        return mTarget;
    }
