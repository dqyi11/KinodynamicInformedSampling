    ...
    ***************************************************************************/
    ...
    namespace internal
    {
            ...
            (int(_Options) & Aligned) == Aligned ? AutoAlign : DontAlign >>
        {
            ...
            typedef traits < Quaternion < _Scalar,
                (int(_Options) & Aligned) == Aligned ? AutoAlign : DontAlign >> TraitsBase;
            enum
            {
    ...
    ***************************************************************************/
        ...
        QuaternionBase<Derived>::operator*(const QuaternionBase<OtherDerived> &other) const
    {
        ...
        return internal::quat_product<Architecture::Target, Derived, OtherDerived,
                                      ...
                                      EIGEN_PLAIN_ENUM_MIN(internal::traits<Derived>::Alignment,
                                                           internal::traits<OtherDerived>::Alignment)>::run(*this,
                                                                                                            other);
    }
    ...
    template <class Derived>
    EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE QuaternionBase<Derived> &QuaternionBase<Derived>::
    ...
    {
        return internal::quat_conj<Architecture::Target, Derived, typename internal::traits<Derived>::Scalar,
