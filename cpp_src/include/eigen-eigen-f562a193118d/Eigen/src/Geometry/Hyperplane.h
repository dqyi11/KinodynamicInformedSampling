...
namespace Eigen
{
    ...
    public:
        ...
        typedef Matrix < Scalar,
            Index(AmbientDimAtCompileTime) == Dynamic ? Dynamic : Index(AmbientDimAtCompileTime) + 1, 1,
        ...
        EIGEN_DEVICE_FUNC VectorType intersection(const Hyperplane &other) const
        {
            ...
            {   // special case where the two lines are
        ...
        isApprox(const Hyperplane<Scalar, AmbientDimAtCompileTime, OtherOptions> &other,
