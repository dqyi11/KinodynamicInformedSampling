...
namespace Eigen
{
    ...
    namespace internal
    {
        ...
        {
            typedef typename make_proper_matrix_type<typename traits<MatrixType>::Scalar, MatrixType::RowsAtCompileTime,
                          ...
                          internal::assign_op<Scalar, typename ArgType::Scalar>, Dense2Dense>
        {
                                              ...
                                              const internal::assign_op<Scalar, typename ArgType::Scalar> &)
            {
                ...
                dst.template topRows<ArgType::RowsAtCompileTime>(src.nestedExpression().rows()) =
                          ...
                          internal::assign_op<Scalar, typename ArgType::Scalar>, Dense2Dense>
        {
                                              ...
                                              const internal::assign_op<Scalar, typename ArgType::Scalar> &)
            {
                ...
                dst.template leftCols<ArgType::ColsAtCompileTime>(src.nestedExpression().cols()) =
                    src.nestedExpression();
        ...
        struct homogeneous_right_product_refactoring_helper
        {
            ...
            typedef CwiseBinaryOp<internal::scalar_sum_op<typename Lhs::Scalar, typename Rhs::Scalar>,
                                  const LinearProduct, const ConstantBlock> Xpr;
        };
        ...
        struct generic_product_impl<Lhs, Homogeneous<RhsArg, Vertical>, DenseShape, HomogeneousShape, ProductTag>
        {
            ...
            {
                homogeneous_left_product_impl<Homogeneous<RhsArg, Vertical>, Lhs>(lhs, rhs.nestedExpression())
                    .evalTo(dst);
            }
        };
                                    ...
                                    HomogeneousShape, ProductTag>
        {
            typedef Transform<Scalar, Dim, Mode, Options> TransformType;
            template <typename Dest>
            EIGEN_DEVICE_FUNC static void evalTo(Dest &dst, const TransformType &lhs,
