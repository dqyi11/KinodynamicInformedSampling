...
#define DST_CTRL(size, count, stride) (((size) << 24) | ((count) << 16) | (stride))
        ...
        static Packet4f p4f_ZERO_ =
            (Packet4f)vec_sl((Packet4ui)p4i_MINUS1,
...
// Define global static constants:
        ...
        static Packet16uc p16uc_HALF64_0_16 =
            vec_sld((Packet16uc)p4i_ZERO, vec_splat((Packet16uc)vec_abs(p4i_MINUS16), 3),
...
#ifdef _BIG_ENDIAN
        static Packet16uc p16uc_COMPLEX32_REV2 = vec_sld(p16uc_FORWARD, p16uc_FORWARD,
...
#define EIGEN_PPC_PREFETCH(ADDR) asm("   dcbt [%[addr]]\n" ::[addr] "r"(ADDR) : "cc");
        ...
        template <>
        EIGEN_STRONG_INLINE void pbroadcast4<Packet4f>(const float *a, Packet4f &a0, Packet4f &a1, Packet4f &a2,
                                                       Packet4f &a3)
        {
            a3 = pload<Packet4f>(a);
            a0 = vec_splat(a3, 0);
        ...
        template <>
        EIGEN_STRONG_INLINE void pbroadcast4<Packet4i>(const int *a, Packet4i &a0, Packet4i &a1, Packet4i &a2,
                                                       Packet4i &a3)
        {
            a3 = pload<Packet4i>(a);
            a0 = vec_splat(a3, 0);
...
//---------- double ----------
        ...
        EIGEN_STRONG_INLINE double predux_mul<Packet2d>(const Packet2d &a)
        {
            return pfirst(pmul(a, reinterpret_cast<Packet2d>(
                                      vec_sld(reinterpret_cast<Packet4ui>(a), reinterpret_cast<Packet4ui>(a), 8))));
        }
