...
// be easily approximated by a polynomial centered on m=1 for stability.
        ...
        EIGEN_DEFINE_FUNCTION_ALLOWING_MULTIPLE_DEFINITIONS EIGEN_UNUSED Packet16f plog<Packet16f>(const Packet16f &_x)
        {
            ...
            return _mm512_mask_blend_ps(iszero_mask, p16f_minus_inf, _mm512_mask_blend_ps(invalid_mask, p16f_nan, x));
        }
#endif
...
// further reducing its effective latency.
        ...
        EIGEN_DEFINE_FUNCTION_ALLOWING_MULTIPLE_DEFINITIONS EIGEN_UNUSED Packet16f psqrt<Packet16f>(const Packet16f &_x)
        {
            ...
            Packet16f x = _mm512_mask_blend_ps(non_zero_mask, _mm512_rsqrt14_ps(_x), _mm512_setzero_ps());
        ...
        EIGEN_DEFINE_FUNCTION_ALLOWING_MULTIPLE_DEFINITIONS EIGEN_UNUSED Packet8d psqrt<Packet8d>(const Packet8d &_x)
        {
            ...
            Packet8d x = _mm512_mask_blend_pd(non_zero_mask, _mm512_rsqrt14_pd(_x), _mm512_setzero_pd());
...
// computing the reciprocal square root in AVX-512.
        ...
        prsqrt<Packet16f>(const Packet16f &_x)
        {
            ...
            Packet16f x = _mm512_mask_blend_ps(le_zero_mask, _mm512_setzero_ps(), _mm512_rsqrt14_ps(_x));

            // Fill in NaNs and Infs for the negative/zero entries.
            __mmask16 neg_mask = _mm512_cmp_ps_mask(_x, _mm512_setzero_ps(), _CMP_LT_OQ);
            Packet16f infs_and_nans = _mm512_mask_blend_ps(
                neg_mask, p16f_nan, _mm512_mask_blend_ps(le_zero_mask, p16f_inf, _mm512_setzero_ps()));
        ...
        EIGEN_DEFINE_FUNCTION_ALLOWING_MULTIPLE_DEFINITIONS EIGEN_UNUSED Packet8d prsqrt<Packet8d>(const Packet8d &_x)
        {
            ...
            Packet8d x = _mm512_mask_blend_pd(le_zero_mask, _mm512_setzero_pd(), _mm512_rsqrt14_pd(_x));
