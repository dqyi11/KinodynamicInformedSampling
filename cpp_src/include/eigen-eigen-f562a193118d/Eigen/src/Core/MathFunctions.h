...
****************************************************************************/
        ...
        ****************************************************************************/
        ...
        struct pow_impl
        {
            ...
            typedef typename ScalarBinaryOpTraits<ScalarX, ScalarY,
        ...
        ****************************************************************************/
        ...
        struct meta_floor_log2_selector
        {
            enum
            {
                ...
                value = (upper <= lower + 1) ? int(meta_floor_log2_terminate) : (n < (1 << middle)) ?
                                               int(meta_floor_log2_move_down) :
                                               (n == 0) ? int(meta_floor_log2_bogus) : int(meta_floor_log2_move_up)
            };
        };
...
#undef EIGEN_TMP_NOOPT_ATTRIB
    ...
    ****************************************************************************/
    ...
    namespace numext
    {
        ...
        template <typename T>
        EIGEN_DEVICE_FUNC EIGEN_ALWAYS_INLINE typename NumTraits<T>::Real abs(const T &x)
        {
            EIGEN_USING_STD_MATH(abs);
            return abs(x);
        }
