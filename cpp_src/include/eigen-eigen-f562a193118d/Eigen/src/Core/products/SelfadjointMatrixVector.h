...
namespace Eigen
{
    namespace internal
    {
        ...
        {
            static EIGEN_DONT_INLINE void run(Index size, const Scalar *lhs, Index lhsStride, const Scalar *rhs,
        ...
        struct selfadjoint_product_impl<Lhs, LhsMode, false, Rhs, 0, true>
        {
            ...
            static void run(Dest &dest, const Lhs &a_lhs, const Rhs &a_rhs, const Scalar &alpha)
            {
                ...
                internal::gemv_static_vector_if<RhsScalar, ActualRhsTypeCleaned::SizeAtCompileTime,
                                                ActualRhsTypeCleaned::MaxSizeAtCompileTime, !UseRhs> static_rhs;
                ...
                internal::selfadjoint_matrix_vector_product < Scalar, Index,
                    (internal::traits<ActualLhsTypeCleaned>::Flags & RowMajorBit) ? RowMajor : ColMajor, int(LhsUpLo),
