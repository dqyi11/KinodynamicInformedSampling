...
namespace Eigen
{
    namespace internal
    {
                  ...
                  Product<EIGEN_SCALAR_BINARYOP_EXPR_RETURN_TYPE(Scalar1, Lhs, product), Rhs, DefaultProduct>>
        {
            ...
            typedef evaluator<
                Product<EIGEN_SCALAR_BINARYOP_EXPR_RETURN_TYPE(Scalar1, Lhs, product), Rhs, DefaultProduct>> Base;
            ...
            : public evaluator<typename Product<Lhs, Rhs, Options>::PlainObject>
        {
            ...
            EIGEN_DEVICE_FUNC
            EIGEN_STRONG_INLINE explicit product_evaluator(const XprType &xpr) : m_result(xpr.rows(), xpr.cols())
            {
...
#define EIGEN_CATCH_ASSIGN_XPR_OP_PRODUCT(ASSIGN_OP, BINOP, ASSIGN_OP2)                                                \
        ...
        ***********************************************************************/
            ...
            : evaluator_base<Product<Lhs, Rhs, LazyProduct>>
        {
            ...
            EIGEN_STRONG_INLINE explicit product_evaluator(const XprType &xpr)
              ...
              , m_rhs(xpr.rhs())
              , m_lhsImpl(m_lhs)
              ,  // FIXME the creation of the evaluator objects should
                 // result in a no-op, but check that!
              m_rhsImpl(m_rhs)
              ,  //       Moreover, they are only useful for the packet
    ...
    std::cerr << "Flags=                " << Flags << "\n";
            ...
            enum
            {
                ...
                CoeffReadCost =
                    InnerSize == 0 ? NumTraits<Scalar>::ReadCost : InnerSize == Dynamic ?
                                     HugeCost :
            ...
            const PacketType packet(Index row, Index col) const
            {
                ...
                typedef etor_product_packet_impl < bool(int(Flags) & RowMajorBit) ? RowMajor : ColMajor,
                    Unroll ? int(InnerSize) : Dynamic, LhsEtorType, RhsEtorType, PacketType, LoadMode > PacketImpl;
        ...
        ****************************************/
        ...
        {
            static EIGEN_STRONG_INLINE void run(Index row, Index col, const Lhs &lhs, const Rhs &rhs, Index innerDim,
                                                Packet &res)
            {
        ...
        struct etor_product_packet_impl<RowMajor, 1, Lhs, Rhs, Packet, LoadMode>
        {
            ...
            {
                res =
                    pmul(pset1<Packet>(lhs.coeff(row, Index(0))), rhs.template packet<LoadMode, Packet>(Index(0), col));
            }
        };
        ...
        struct etor_product_packet_impl<ColMajor, 1, Lhs, Rhs, Packet, LoadMode>
        {
            ...
            {
                res =
                    pmul(lhs.template packet<LoadMode, Packet>(row, Index(0)), pset1<Packet>(rhs.coeff(Index(0), col)));
            }
        };
        ...
        ***************************************************************************/
        ...
        {
            typedef typename ScalarBinaryOpTraits<typename MatrixType::Scalar,
                                              ...
                                              OnTheLeft>
        {
            typedef diagonal_product_evaluator_base<Rhs, typename Lhs::DiagonalVectorType,
                                                    Product<Lhs, Rhs, LazyProduct>, OnTheLeft> Base;
                                              ...
                                              OnTheRight>
        {
            typedef diagonal_product_evaluator_base<Lhs, typename Rhs::DiagonalVectorType,
                                                    Product<Lhs, Rhs, LazyProduct>, OnTheRight> Base;
            using Base::m_diagImpl;
            using Base::m_matImpl;
            using Base::coeff;
            typedef typename Base::Scalar Scalar;
