    ...
    namespace internal
    {
        ...
        struct gemv_static_vector_if<Scalar, Size, MaxSize, true>
        {
            ...
            internal::plain_array<Scalar, EIGEN_SIZE_MIN_PREFER_FIXED(Size, MaxSize), 0,
                                  EIGEN_PLAIN_ENUM_MIN(AlignedMax, PacketSize)> m_data;
            EIGEN_STRONG_INLINE Scalar *data()
            {
                return m_data.array;
            }
        ...
        struct gemv_dense_selector<OnTheLeft, StorageOrder, BlasCompatible>
        {
            ...
            static void run(const Lhs &lhs, const Rhs &rhs, Dest &dest, const typename Dest::Scalar &alpha)
            {
                ...
                gemv_dense_selector<OnTheRight, OtherStorageOrder, BlasCompatible>::run(rhs.transpose(),
                                                                                        lhs.transpose(), destT, alpha);
            }
        };
        ...
        struct gemv_dense_selector<OnTheRight, ColMajor, true>
        {
            ...
            static inline void run(const Lhs &lhs, const Rhs &rhs, Dest &dest, const typename Dest::Scalar &alpha)
            {
                ...
                ResScalar actualAlpha =
                    alpha * LhsBlasTraits::extractScalarFactor(lhs) * RhsBlasTraits::extractScalarFactor(rhs);
        ...
        struct gemv_dense_selector<OnTheRight, RowMajor, true>
        {
            ...
            static void run(const Lhs &lhs, const Rhs &rhs, Dest &dest, const typename Dest::Scalar &alpha)
            {
                ...
                gemv_static_vector_if<RhsScalar, ActualRhsTypeCleaned::SizeAtCompileTime,
                                      ActualRhsTypeCleaned::MaxSizeAtCompileTime, !DirectlyUseRhs> static_rhs;
