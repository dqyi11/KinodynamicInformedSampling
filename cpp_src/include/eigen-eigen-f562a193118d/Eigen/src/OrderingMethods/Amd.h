...
namespace Eigen
{
    namespace internal
    {
        ...
        template <typename StorageIndex>
        StorageIndex cs_tdfs(StorageIndex j, StorageIndex k, StorageIndex *head, const StorageIndex *next,
                                     ...
                                     PermutationMatrix<Dynamic, Dynamic, StorageIndex> &perm)
        {
            ...
            StorageIndex d, dk, dext, lemax = 0, e, elenk, eln, i, j, k, k1, k2, k3, jlast, ln, dense, nzmax,
