...
namespace Eigen
{
    ...
    {
        cholmod_sparse res =
            viewAsCholmod(Ref<SparseMatrix<_Scalar, _Options, _Index>>(mat.matrix().const_cast_derived()));
    ...
    public:
        ...
        {
            eigen_assert(m_factorizationIsOk && "The decomposition is not in a valid state for solving, you "
        ...
        void _solve_impl(const SparseMatrixBase<RhsDerived> &b, SparseMatrixBase<DestDerived> &dest) const
        {
            ...
            // alignment, etc.)
            dest.derived() =
                viewAsEigen<typename DestDerived::Scalar, ColMajor, typename DestDerived::StorageIndex>(*x_cs);
