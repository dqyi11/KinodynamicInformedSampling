...
#define DECL_GSSVX(PREFIX, FLOATTYPE, KEYTYPE)                                                                         \
    extern "C" {                                                                                                       \
    extern void PREFIX##gssvx(superlu_options_t *, SuperMatrix *, int *, int *, int *, char *, FLOATTYPE *,            \
                              FLOATTYPE *, SuperMatrix *, SuperMatrix *, void *, int, SuperMatrix *, SuperMatrix *,    \
                              FLOATTYPE *, FLOATTYPE *, FLOATTYPE *, FLOATTYPE *, GlobalLU_t *, mem_usage_t *,         \
                              SuperLUStat_t *, int *);                                                                 \
    }                                                                                                                  \
...
#define DECL_GSSVX(PREFIX, FLOATTYPE, KEYTYPE)                                                                         \
    ...
    extern void PREFIX##gssvx(superlu_options_t *, SuperMatrix *, int *, int *, int *, char *, FLOATTYPE *,            \
                              FLOATTYPE *, SuperMatrix *, SuperMatrix *, void *, int, SuperMatrix *, SuperMatrix *,    \
                              FLOATTYPE *, FLOATTYPE *, FLOATTYPE *, FLOATTYPE *, mem_usage_t *, SuperLUStat_t *,      \
                              int *);                                                                                  \
    }                                                                                                                  \
    inline float SuperLU_gssvx(superlu_options_t *options, SuperMatrix *A, int *perm_c, int *perm_r, int *etree,       \
                               char *equed, FLOATTYPE *R, FLOATTYPE *C, SuperMatrix *L, SuperMatrix *U, void *work,    \
...
#define DECL_GSISX(PREFIX, FLOATTYPE, KEYTYPE)                                                                         \
    extern "C" {                                                                                                       \
    extern void PREFIX##gsisx(superlu_options_t *, SuperMatrix *, int *, int *, int *, char *, FLOATTYPE *,            \
                              FLOATTYPE *, SuperMatrix *, SuperMatrix *, void *, int, SuperMatrix *, SuperMatrix *,    \
                              FLOATTYPE *, FLOATTYPE *, mem_usage_t *, SuperLUStat_t *, int *);                        \
    }                                                                                                                  \
    ...
    struct SluMatrix : SuperMatrix
    {
        ...
        static SluMatrix Map(MatrixBase<MatrixType> &_mat)
        {
            ...
            eigen_assert(((MatrixType::Flags & RowMajorBit) != RowMajorBit) && "row-major dense matrices are not "
        ...
        static SluMatrix Map(SparseMatrixBase<MatrixType> &a_mat)
        {
            ...
            eigen_assert(((MatrixType::Flags & SelfAdjoint) == 0) && "SelfAdjoint matrix shape not supported by "
                                                                     "SuperLU");
    ...
    void SuperLU<MatrixType>::factorize(const MatrixType &a)
    {
        ...
        SuperLU_gssvx(&m_sluOptions, &m_sluA, m_q.data(), m_p.data(), &m_sluEtree[0], &m_sluEqued, &m_sluRscale[0],
                      &m_sluCscale[0], &m_sluL, &m_sluU, NULL, 0, &m_sluB, &m_sluX, &recip_pivot_growth, &rcond, &ferr,
    ...
    void SuperLU<MatrixType>::_solve_impl(const MatrixBase<Rhs> &b, MatrixBase<Dest> &x) const
    {
        eigen_assert(m_factorizationIsOk && "The decomposition is not in a valid "
                                            "state for solving, you must first call "
                                            "either compute() or "
    ...
    {
        eigen_assert(m_factorizationIsOk && "The decomposition is not in a valid "
                                            "state for extracting factors, you must "
                                            "first call either compute() or "
                                            "analyzePattern()/factorize()");
        if (m_extractedDataAreDirty)
        {
            int upper;
    ...
    {
        eigen_assert(m_factorizationIsOk && "The decomposition is not in a valid "
                                            "state for computing the determinant, "
                                            "you must first call either compute() or "
                                            "analyzePattern()/factorize()");
