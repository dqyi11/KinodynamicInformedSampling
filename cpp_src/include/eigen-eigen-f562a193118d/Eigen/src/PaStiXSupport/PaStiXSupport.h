...
#define PASTIX_DCOMPLEX std::complex<double>
    ...
    namespace internal
    {
        ...
        void eigen_pastix(pastix_data_t **pastix_data, int pastix_comm, int n, int *ptr, int *idx, float *vals,
        ...
        void eigen_pastix(pastix_data_t **pastix_data, int pastix_comm, int n, int *ptr, int *idx, double *vals,
    ...
    protected:
        ...
        void clean()
        {
            ...
            internal::eigen_pastix(&m_pastixdata, MPI_COMM_WORLD, 0, 0, 0, (Scalar *)0, m_perm.data(), m_invp.data(), 0,
