...
namespace Eigen
{
    namespace internal
    {
        ...
        protected:
            ...
            Index memInit(Index m, Index n, Index annz, Index lwork, Index fillratio, Index panel_size,
                          GlobalLU_t &glu);
            template <typename VectorType>
            ...
            void dfs_kernel(const StorageIndex jj, IndexVector &perm_r, Index &nseg, IndexVector &panel_lsub,
            ...
            void panel_dfs(const Index m, const Index w, const Index jcol, MatrixType &A, IndexVector &perm_r,
