    ...
    namespace internal
    {
            ...
            : public traits<SparseMatrix<MatScalar, MatOptions, MatIndex>>
        {
            ...
            struct match
            {
                ...
                typedef typename internal::conditional<MatchAtCompileTime, internal::true_type,
        ...
        protected:
            ...
            void construct(Expression &expr)
            {
                if (expr.outerIndexPtr() == 0)
                    ...
                    ::new (static_cast<Base *>(this))
                        Base(expr.rows(), expr.cols(), expr.nonZeros(), expr.outerIndexPtr(), expr.innerIndexPtr(),
...
/**
  ...
  */
    ...
    class Ref<SparseMatrixType, Options> : public SparseMapBase<Derived, WriteAccessors>  // yes, that's weird to use
...
/**
  ...
  */
    ...
    namespace internal
    {
        ...
        {
            typedef evaluator<
                SparseCompressedBase<Ref<SparseMatrix<MatScalar, MatOptions, MatIndex>, Options, StrideType>>> Base;
                  ...
                  SparseCompressedBase<Ref<const SparseMatrix<MatScalar, MatOptions, MatIndex>, Options, StrideType>>>
        {
            typedef evaluator<SparseCompressedBase<
                Ref<const SparseMatrix<MatScalar, MatOptions, MatIndex>, Options, StrideType>>> Base;
        ...
        {
            typedef evaluator<
                SparseCompressedBase<Ref<SparseVector<MatScalar, MatOptions, MatIndex>, Options, StrideType>>> Base;
        ...
        {
            typedef evaluator<SparseCompressedBase<
                Ref<const SparseVector<MatScalar, MatOptions, MatIndex>, Options, StrideType>>> Base;
