...
namespace Eigen
{
    ...
    inline const Product<Derived, OtherDerived, AliasFreeProduct> SparseMatrixBase<Derived>::
    ...
    namespace internal
    {
        ...
        struct generic_product_impl<Lhs, Rhs, SparseShape, SparseShape, ProductType>
        {
            ...
            static void addTo(Dest &dst, const ActualLhs &lhs, const Rhs &rhs,
                              typename enable_if<is_same<typename evaluator_traits<Dest>::Shape, DenseShape>::value,
                                                 int *>::type * = 0)
            {
                ...
                internal::sparse_sparse_to_dense_product_selector<
                    typename remove_all<LhsNested>::type, typename remove_all<RhsNested>::type, Dest>::run(lhsNested,
                                                                                                           rhsNested,
                                                                                                           dst);
            }
