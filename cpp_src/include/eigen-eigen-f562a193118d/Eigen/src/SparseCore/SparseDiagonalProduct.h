...
namespace Eigen
{
    ...
    namespace internal
    {
        ...
        template <typename Lhs, typename Rhs, int ProductTag>
            ...
            typename Lhs::DiagonalVectorType, Rhs::Flags &RowMajorBit ? SDP_AsScalarProduct : SDP_AsCwiseProduct >
        {
        ...
        struct sparse_diagonal_product_evaluator<SparseXprType, DiagCoeffType, SDP_AsCwiseProduct>
        {
            ...
            typedef typename nested_eval < DiagCoeffType, SparseXprType::IsRowMajor ?
