...
namespace Eigen
{
    ...
    public:
        ...
        void resize(Index rows, Index cols)
        {
            ...
            eigen_assert(rows == this->rows() && cols == this->cols() && "SparseSelfadjointView::resize() does not "
                                                                         "actually allow to resize.");
        }
    ...
    ***************************************************************************/
    ...
    namespace internal
    {
        ...
        struct Assignment<DstXprType, SrcXprType, Functor, SparseSelfAdjoint2Sparse>
        {
            ...
            static void
            run(DynamicSparseMatrix<DestScalar, ColMajor, StorageIndex> &dst, const SrcXprType &src,
                const internal::assign_op<typename DstXprType::Scalar, typename SrcXprType::Scalar> & /*func*/)
            {
    ...
    ***************************************************************************/
    ...
    namespace internal
    {
        ...
        inline void sparse_selfadjoint_time_dense_product(const SparseLhsType &lhs, const DenseRhsType &rhs,
                                                          DenseResType &res, const AlphaType &alpha)
        {
            EIGEN_ONLY_USED_FOR_DEBUG(alpha);

            typedef typename internal::nested_eval<SparseLhsType, DenseRhsType::MaxColsAtCompileTime>::type
                SparseLhsTypeNested;
            ...
            enum
            {
                ...
                ProcessFirstHalf = ((Mode & (Upper | Lower)) == (Upper | Lower)) ||
                                   ((Mode & Upper) && !LhsIsRowMajor) || ((Mode & Lower) && LhsIsRowMajor),
                  ...
                  Lhs, RhsView, generic_product_impl<Lhs, RhsView, DenseShape, SparseSelfAdjointShape, ProductType>>
        {
                                      ...
                                      const typename Dest::Scalar &alpha)
            {
                ...
                internal::sparse_selfadjoint_time_dense_product<RhsView::Mode>(rhsNested.transpose(),
