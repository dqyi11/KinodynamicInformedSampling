...
namespace Eigen
{
    namespace internal
    {
        ...
        ****************************/
        ...
        struct compute_inverse_and_det_with_check<MatrixType, ResultType, 1>
        {
            ...
            static inline void run(const MatrixType &matrix,
                                   const typename MatrixType::RealScalar &absDeterminantThreshold, ResultType &result,
        ...
        ****************************/
        ...
        struct compute_inverse_and_det_with_check<MatrixType, ResultType, 2>
        {
            EIGEN_DEVICE_FUNC
            static inline void run(const MatrixType &matrix,
                                   const typename MatrixType::RealScalar &absDeterminantThreshold, ResultType &inverse,
                                   typename ResultType::Scalar &determinant, bool &invertible)
            {
                using std::abs;
                typedef typename ResultType::Scalar Scalar;
        ...
        ****************************/
        ...
        compute_inverse_size3_helper(const MatrixType &matrix, const typename ResultType::Scalar &invdet,
        ...
        ****************************/
        ...
        EIGEN_DEVICE_FUNC inline const typename Derived::Scalar general_det3_helper(const MatrixBase<Derived> &matrix,
                                                                   ...
                                                                   const RealScalar &absDeterminantThreshold) const
    {
        ...
        internal::compute_inverse_and_det_with_check<MatrixType, ResultType>::run(derived(), absDeterminantThreshold,
