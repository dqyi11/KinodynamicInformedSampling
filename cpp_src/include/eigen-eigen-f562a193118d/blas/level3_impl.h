                          ...
                          const int *ldb, const RealScalar *pbeta, RealScalar *pc, const int *ldc)
{
    ...
    static const functype func[12] = {// array index: NOTR  | (NOTR << 2)
                                      (internal::general_matrix_matrix_product<DenseIndex, Scalar, ColMajor, false,
                                                                               Scalar, ColMajor, false, ColMajor>::run),
                                      // array index: TR    | (NOTR << 2)
                                      (internal::general_matrix_matrix_product<DenseIndex, Scalar, RowMajor, false,
                                                                               Scalar, ColMajor, false, ColMajor>::run),
                                      // array index: ADJ   | (NOTR << 2)
                                      (internal::general_matrix_matrix_product<DenseIndex, Scalar, RowMajor, Conj,
                                                                               Scalar, ColMajor, false, ColMajor>::run),
                                      0,
                                      ...
                                      (internal::general_matrix_matrix_product<DenseIndex, Scalar, ColMajor, false,
                                                                               Scalar, RowMajor, Conj, ColMajor>::run),
                          ...
                          const int *ldb)
{
    ...
    static const functype func[32] = {
        ...
        (internal::triangular_solve_matrix<Scalar, DenseIndex, OnTheLeft, Lower | 0, Conj, RowMajor, ColMajor>::run), 0,
        ...
        (internal::triangular_solve_matrix<Scalar, DenseIndex, OnTheLeft, Upper | 0, Conj, RowMajor, ColMajor>::run), 0,
        ...
        (internal::triangular_solve_matrix<Scalar, DenseIndex, OnTheLeft, Upper | UnitDiag, false, ColMajor,
                                           ColMajor>::run),
        // array index: TR    | (LEFT  << 2) | (UP << 3) | (UNIT  << 4)
        (internal::triangular_solve_matrix<Scalar, DenseIndex, OnTheLeft, Lower | UnitDiag, false, RowMajor,
                                           ColMajor>::run),
        // array index: ADJ   | (LEFT  << 2) | (UP << 3) | (UNIT  << 4)
        (internal::triangular_solve_matrix<Scalar, DenseIndex, OnTheLeft, Lower | UnitDiag, Conj, RowMajor,
                                           ColMajor>::run),
        0,
        // array index: NOTR  | (RIGHT << 2) | (UP << 3) | (UNIT  << 4)
        (internal::triangular_solve_matrix<Scalar, DenseIndex, OnTheRight, Upper | UnitDiag, false, ColMajor,
                                           ColMajor>::run),
        // array index: TR    | (RIGHT << 2) | (UP << 3) | (UNIT  << 4)
        (internal::triangular_solve_matrix<Scalar, DenseIndex, OnTheRight, Lower | UnitDiag, false, RowMajor,
                                           ColMajor>::run),
        // array index: ADJ   | (RIGHT << 2) | (UP << 3) | (UNIT  << 4)
        (internal::triangular_solve_matrix<Scalar, DenseIndex, OnTheRight, Lower | UnitDiag, Conj, RowMajor,
                                           ColMajor>::run),
        0,
        // array index: NOTR  | (LEFT  << 2) | (LO << 3) | (UNIT  << 4)
        (internal::triangular_solve_matrix<Scalar, DenseIndex, OnTheLeft, Lower | UnitDiag, false, ColMajor,
                                           ColMajor>::run),
        // array index: TR    | (LEFT  << 2) | (LO << 3) | (UNIT  << 4)
        (internal::triangular_solve_matrix<Scalar, DenseIndex, OnTheLeft, Upper | UnitDiag, false, RowMajor,
                                           ColMajor>::run),
        // array index: ADJ   | (LEFT  << 2) | (LO << 3) | (UNIT  << 4)
        (internal::triangular_solve_matrix<Scalar, DenseIndex, OnTheLeft, Upper | UnitDiag, Conj, RowMajor,
                                           ColMajor>::run),
        0,
        // array index: NOTR  | (RIGHT << 2) | (LO << 3) | (UNIT  << 4)
        (internal::triangular_solve_matrix<Scalar, DenseIndex, OnTheRight, Lower | UnitDiag, false, ColMajor,
                                           ColMajor>::run),
        // array index: TR    | (RIGHT << 2) | (LO << 3) | (UNIT  << 4)
        (internal::triangular_solve_matrix<Scalar, DenseIndex, OnTheRight, Upper | UnitDiag, false, RowMajor,
                                           ColMajor>::run),
        // array index: ADJ   | (RIGHT << 2) | (LO << 3) | (UNIT  << 4)
        (internal::triangular_solve_matrix<Scalar, DenseIndex, OnTheRight, Upper | UnitDiag, Conj, RowMajor,
                                           ColMajor>::run),
        0};
                          ...
                          const int *ldb)
{
    ...
    static const functype func[32] = {
        // array index: NOTR  | (LEFT  << 2) | (UP << 3) | (NUNIT << 4)
        (internal::product_triangular_matrix_matrix<Scalar, DenseIndex, Upper | 0, true, ColMajor, false, ColMajor,
                                                    false, ColMajor>::run),
        // array index: TR    | (LEFT  << 2) | (UP << 3) | (NUNIT << 4)
        (internal::product_triangular_matrix_matrix<Scalar, DenseIndex, Lower | 0, true, RowMajor, false, ColMajor,
                                                    false, ColMajor>::run),
        // array index: ADJ   | (LEFT  << 2) | (UP << 3) | (NUNIT << 4)
        (internal::product_triangular_matrix_matrix<Scalar, DenseIndex, Lower | 0, true, RowMajor, Conj, ColMajor,
                                                    false, ColMajor>::run),
        0,
        // array index: NOTR  | (RIGHT << 2) | (UP << 3) | (NUNIT << 4)
        ...
        0,
        // array index: NOTR  | (LEFT  << 2) | (LO << 3) | (NUNIT << 4)
        (internal::product_triangular_matrix_matrix<Scalar, DenseIndex, Lower | 0, true, ColMajor, false, ColMajor,
                                                    false, ColMajor>::run),
        // array index: TR    | (LEFT  << 2) | (LO << 3) | (NUNIT << 4)
        (internal::product_triangular_matrix_matrix<Scalar, DenseIndex, Upper | 0, true, RowMajor, false, ColMajor,
                                                    false, ColMajor>::run),
        // array index: ADJ   | (LEFT  << 2) | (LO << 3) | (NUNIT << 4)
        (internal::product_triangular_matrix_matrix<Scalar, DenseIndex, Upper | 0, true, RowMajor, Conj, ColMajor,
                                                    false, ColMajor>::run),
        0,
        // array index: NOTR  | (RIGHT << 2) | (LO << 3) | (NUNIT << 4)
        ...
        0,
        // array index: NOTR  | (LEFT  << 2) | (UP << 3) | (UNIT  << 4)
        (internal::product_triangular_matrix_matrix<Scalar, DenseIndex, Upper | UnitDiag, true, ColMajor, false,
                                                    ColMajor, false, ColMajor>::run),
        // array index: TR    | (LEFT  << 2) | (UP << 3) | (UNIT  << 4)
        (internal::product_triangular_matrix_matrix<Scalar, DenseIndex, Lower | UnitDiag, true, RowMajor, false,
                                                    ColMajor, false, ColMajor>::run),
        // array index: ADJ   | (LEFT  << 2) | (UP << 3) | (UNIT  << 4)
        (internal::product_triangular_matrix_matrix<Scalar, DenseIndex, Lower | UnitDiag, true, RowMajor, Conj,
                                                    ColMajor, false, ColMajor>::run),
        0,
        // array index: NOTR  | (RIGHT << 2) | (UP << 3) | (UNIT  << 4)
        ...
        0,
        // array index: NOTR  | (LEFT  << 2) | (LO << 3) | (UNIT  << 4)
        (internal::product_triangular_matrix_matrix<Scalar, DenseIndex, Lower | UnitDiag, true, ColMajor, false,
                                                    ColMajor, false, ColMajor>::run),
        // array index: TR    | (LEFT  << 2) | (LO << 3) | (UNIT  << 4)
        (internal::product_triangular_matrix_matrix<Scalar, DenseIndex, Upper | UnitDiag, true, RowMajor, false,
                                                    ColMajor, false, ColMajor>::run),
        // array index: ADJ   | (LEFT  << 2) | (LO << 3) | (UNIT  << 4)
        (internal::product_triangular_matrix_matrix<Scalar, DenseIndex, Upper | UnitDiag, true, RowMajor, Conj,
                                                    ColMajor, false, ColMajor>::run),
        0,
        // array index: NOTR  | (RIGHT << 2) | (LO << 3) | (UNIT  << 4)
        (internal::product_triangular_matrix_matrix<Scalar, DenseIndex, Lower | UnitDiag, false, ColMajor, false,
                          ...
                          const RealScalar *pbeta, RealScalar *pc, const int *ldc)
{
    ...
    if (SIDE(*side) == LEFT)
        if (UPLO(*uplo) == UP)
            internal::product_selfadjoint_matrix<Scalar, DenseIndex, RowMajor, true, false, ColMajor, false, false,
                                                 ColMajor>::run(*m, *n, a, *lda, b, *ldb, c, *ldc, alpha, blocking);
        else if (UPLO(*uplo) == LO)
            internal::product_selfadjoint_matrix<Scalar, DenseIndex, ColMajor, true, false, ColMajor, false, false,
                                                 ColMajor>::run(*m, *n, a, *lda, b, *ldb, c, *ldc, alpha, blocking);
        else
            return 0;
    else if (SIDE(*side) == RIGHT)
        if (UPLO(*uplo) == UP)
            internal::product_selfadjoint_matrix<Scalar, DenseIndex, ColMajor, false, false, RowMajor, true, false,
                                                 ColMajor>::run(*m, *n, b, *ldb, a, *lda, c, *ldc, alpha, blocking);
        else if (UPLO(*uplo) == LO)
            internal::product_selfadjoint_matrix<Scalar, DenseIndex, ColMajor, false, false, ColMajor, true, false,
                                                 ColMajor>::run(*m, *n, b, *ldb, a, *lda, c, *ldc, alpha, blocking);
        else
            return 0;
    else
...
int EIGEN_BLAS_FUNC(syrk)(const char *uplo, const char *op, const int *n, const int *k, const RealScalar *palpha,
                          const RealScalar *pa, const int *lda, const RealScalar *pbeta, RealScalar *pc, const int *ldc)
{
...
//   " " << *palpha << " " << *lda << " " << *pbeta << " " << *ldc << "\n";
    ...
    static const functype func[8] = {
        ...
        (internal::general_matrix_matrix_triangular_product<DenseIndex, Scalar, ColMajor, false, Scalar, RowMajor,
                                                            ColMajor, Conj, Upper>::run),
        // array index: TR    | (UP << 2)
        (internal::general_matrix_matrix_triangular_product<DenseIndex, Scalar, RowMajor, false, Scalar, ColMajor,
                                                            ColMajor, Conj, Upper>::run),
        // array index: ADJ   | (UP << 2)
        (internal::general_matrix_matrix_triangular_product<DenseIndex, Scalar, RowMajor, Conj, Scalar, ColMajor,
                                                            ColMajor, false, Upper>::run),
        0,
        // array index: NOTR  | (LO << 2)
        (internal::general_matrix_matrix_triangular_product<DenseIndex, Scalar, ColMajor, false, Scalar, RowMajor,
                                                            ColMajor, Conj, Lower>::run),
        // array index: TR    | (LO << 2)
        (internal::general_matrix_matrix_triangular_product<DenseIndex, Scalar, RowMajor, false, Scalar, ColMajor,
                                                            ColMajor, Conj, Lower>::run),
        // array index: ADJ   | (LO << 2)
        (internal::general_matrix_matrix_triangular_product<DenseIndex, Scalar, RowMajor, Conj, Scalar, ColMajor,
                                                            ColMajor, false, Lower>::run),
        0};
#endif
                          ...
                          const RealScalar *pbeta, RealScalar *pc, const int *ldc)
{
    ...
    {
        if (UPLO(*uplo) == UP)
            internal::product_selfadjoint_matrix<Scalar, DenseIndex, RowMajor, true, Conj, ColMajor, false, false,
                                                 ColMajor>::run(*m, *n, a, *lda, b, *ldb, c, *ldc, alpha, blocking);
        else if (UPLO(*uplo) == LO)
            internal::product_selfadjoint_matrix<Scalar, DenseIndex, ColMajor, true, false, ColMajor, false, false,
                                                 ColMajor>::run(*m, *n, a, *lda, b, *ldb, c, *ldc, alpha, blocking);
                          ...
                          const RealScalar *pa, const int *lda, const RealScalar *pbeta, RealScalar *pc, const int *ldc)
{
    ...
    {
        internal::gemm_blocking_space<ColMajor, Scalar, Scalar, Dynamic, Dynamic, Dynamic> blocking(*n, *n, *k, 1,
                                                                                                    false);
        func[code](*n, *k, a, *lda, a, *lda, c, *ldc, alpha, blocking);
        matrix(c, *n, *n, *ldc).diagonal().imag().setZero();
    }
