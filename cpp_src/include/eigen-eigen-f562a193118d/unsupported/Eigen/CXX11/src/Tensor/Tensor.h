...
namespace Eigen
{
    /** \class Tensor
      ...
      * \tparam Options_ \anchor tensor_tparam_options A combination of either \b
    ...
    public:
        ...
        EIGEN_DEVICE_FUNC inline const Scalar &coeff(Index firstIndex, Index secondIndex,
...
#else
        EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE explicit Tensor(Index dim1) : m_storage(dim1, array<Index, 1>(dim1))
        {
