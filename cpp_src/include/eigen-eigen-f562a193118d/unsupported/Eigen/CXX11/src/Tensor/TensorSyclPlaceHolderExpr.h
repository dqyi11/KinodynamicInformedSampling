...
#define SELECTEXPR(CVQual)                                                                                             \
    ...
    {                                                                                                                  \
        typedef CVQual                                                                                                 \
            typename CategoryHelper<TensorSelectOp, NoOP,                                                              \
...
#define ASSIGNEXPR(CVQual)                                                                                             \
    ...
    {                                                                                                                  \
        typedef CVQual typename CategoryHelper<TensorAssignOp, NoOP,                                                   \
...
#define TENSORMAPEXPR(CVQual)                                                                                          \
    ...
    struct PlaceHolderExpression<                                                                                      \
        CVQual TensorMap<Tensor<Scalar_, NumIndices_, Options_, IndexType_>, Options2_, MakePointer_>, N>              \
    {                                                                                                                  \
        typedef CVQual PlaceHolder<                                                                                    \
            CVQual TensorMap<Tensor<Scalar_, NumIndices_, Options_, IndexType_>, Options2_, MakePointer_>, N> Type;    \
    };
