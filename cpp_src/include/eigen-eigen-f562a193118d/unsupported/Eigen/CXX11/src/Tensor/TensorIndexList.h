...
namespace Eigen
{
    ...
    namespace internal
    {
        ...
        struct tuple_coeff
        {
            ...
            template <typename... T>
            EIGEN_DEVICE_FUNC static constexpr bool value_known_statically(const DenseIndex i,
    ...
    struct IndexList : internal::IndexTuple<FirstType, OtherTypes...>
    {
        ...
        {
            return internal::tuple_coeff<internal::array_size<internal::IndexTuple<FirstType, OtherTypes...>>::value -
                                             1,
