    ...
    namespace TensorSycl
    {
        namespace internal
        {
            ...
            struct AccessorConstructor
            {
                ...
                static inline auto getTuple(cl::sycl::handler &cgh, Arg1 eval1, Arg2 eval2, Arg3 eval3) -> decltype(
                ...
                static inline auto getAccessor(cl::sycl::handler &cgh, Arg eval) -> decltype(utility::tuple::make_tuple(
                    eval.device()
                        .template get_sycl_accessor<
                            AcM, typename Eigen::internal::remove_all<typename Arg::CoeffReturnType>::type>(
            ...
            template <template <class, class, class> class BinaryCategory, typename OP, typename LHSExpr,
            ...
            template <template <class, class, class, class> class TernaryCategory, typename OP, typename Arg1Expr,
            ...
            struct ExtractAccessor<TensorEvaluator<const TensorSelectOp<IfExpr, ThenExpr, ElseExpr>, Dev>>
            {
                static inline auto getTuple(
                    ...
                    -> decltype(AccessorConstructor::getTuple(cgh, eval.cond_impl(), eval.then_impl(),
                                                              eval.else_impl()))
                {
