    ...
    namespace TensorSycl
    {
        namespace internal
        {
            ...
            struct FunctorExtractor<TensorEvaluator<const TernaryCategory<OP, Arg1Expr, Arg2Expr, Arg3Expr>, Dev>>
            {
                ...
                OP func;
                FunctorExtractor(
                    const TensorEvaluator<const TernaryCategory<OP, Arg1Expr, Arg2Expr, Arg3Expr>, Dev> &expr)
            ...
            struct FunctorExtractor<TensorEvaluator<const TensorReductionOp<Op, Dims, ArgType, MakePointer_>, Device>>
            {
                ...
                FunctorExtractor(
                    const TensorEvaluator<const TensorReductionOp<Op, Dims, ArgType, MakePointer_>, Device> &expr)
