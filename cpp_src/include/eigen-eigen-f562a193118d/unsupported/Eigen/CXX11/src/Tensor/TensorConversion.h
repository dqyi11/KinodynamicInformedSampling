    ...
    struct TensorEvaluator<const TensorConversionOp<TargetType, ArgType>, Device>
    {
        ...
        EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE bool evalSubExprsIfNeeded(Scalar *data)
        {
            return ConversionSubExprEval<internal::is_same<TargetType, SrcType>::value,
                                         TensorEvaluator<ArgType, Device>, Scalar>::run(m_impl, data);
        }
    ...
    protected:
        ...
        struct PacketConv<LoadMode, true>
        {
            ...
            run(const TensorEvaluator<ArgType, Device> &impl, Index index)
            {
                ...
                PacketConverter<TensorEvaluator<ArgType, Device>, PacketSourceType, PacketReturnType, SrcCoeffRatio,
                                TgtCoeffRatio> converter(impl);
