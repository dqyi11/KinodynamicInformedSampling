...
#define TENSORMAP(CVQual)                                                                                              \
    ...
    struct ExprConstructor<                                                                                            \
        ...
        CVQual PlaceHolder<                                                                                            \
            CVQual TensorMap<Tensor<Scalar_, NumIndices_, Options_, IndexType_>, Options3_, MakePointer_>, N>,         \
        Params...>                                                                                                     \
    {                                                                                                                  \
        typedef CVQual TensorMap<Tensor<Scalar_, NumIndices_, Options_, IndexType_>, Options2_, MakeGlobalPointer>     \
            Type;                                                                                                      \
        Type expr;                                                                                                     \
...
#define UNARYCATEGORY(CVQual)                                                                                          \
    template <template <class, class> class UnaryCategory, typename OP, typename OrigRHSExpr, typename RHSExpr,        \
              typename... Params>                                                                                      \
...
#define BINARYCATEGORY(CVQual)                                                                                         \
    template <template <class, class, class> class BinaryCategory, typename OP, typename OrigLHSExpr,                  \
              typename OrigRHSExpr, typename LHSExpr, typename RHSExpr, typename... Params>                            \
    struct ExprConstructor<CVQual BinaryCategory<OP, OrigLHSExpr, OrigRHSExpr>,                                        \
                           CVQual BinaryCategory<OP, LHSExpr, RHSExpr>, Params...>                                     \
    {                                                                                                                  \
...
#define TERNARYCATEGORY(CVQual)                                                                                        \
    template <template <class, class, class, class> class TernaryCategory, typename OP, typename OrigArg1Expr,         \
              typename OrigArg2Expr, typename OrigArg3Expr, typename Arg1Expr, typename Arg2Expr, typename Arg3Expr,   \
              typename... Params>                                                                                      \
    ...
    {                                                                                                                  \
        ...
        typedef CVQual TernaryCategory<OP, typename my_arg1_type::Type, typename my_arg2_type::Type,                   \
                                       typename my_arg3_type::Type> Type;                                              \
...
#define SELECTOP(CVQual)                                                                                               \
    template <typename OrigIfExpr, typename OrigThenExpr, typename OrigElseExpr, typename IfExpr, typename ThenExpr,   \
              typename ElseExpr, typename... Params>                                                                   \
    ...
    {                                                                                                                  \
        ...
        typedef CVQual                                                                                                 \
            TensorSelectOp<typename my_if_type::Type, typename my_then_type::Type, typename my_else_type::Type> Type;  \
        my_if_type ifExpr;                                                                                             \
...
#define ASSIGN(CVQual)                                                                                                 \
    ...
    struct ExprConstructor<CVQual TensorAssignOp<OrigLHSExpr, OrigRHSExpr>, CVQual TensorAssignOp<LHSExpr, RHSExpr>,   \
                           Params...>                                                                                  \
    {                                                                                                                  \
        typedef ExprConstructor<OrigLHSExpr, LHSExpr, Params...> my_left_type;                                         \
        typedef ExprConstructor<OrigRHSExpr, RHSExpr, Params...> my_right_type;                                        \
...
#define SYCLREDUCTIONEXPR(CVQual)                                                                                      \
    ...
    {                                                                                                                  \
        static const size_t NumIndices =                                                                               \
            ValueCondition<TensorReductionOp<OP, Dim, DevExpr, MakeGlobalPointer>::NumDimensions == 0, 1,              \
        ...
        typedef CVQual TensorMap<Tensor<typename TensorReductionOp<OP, Dim, DevExpr, MakeGlobalPointer>::Scalar,       \
                                        NumIndices, 0, typename TensorReductionOp<OP, Dim, DevExpr>::Index>,           \
                                 0, MakeGlobalPointer> Type;                                                           \
        Type expr;                                                                                                     \
        template <typename FuncDetector>                                                                               \
        ExprConstructor(FuncDetector &fd, const utility::tuple::Tuple<Params...> &t)                                   \
