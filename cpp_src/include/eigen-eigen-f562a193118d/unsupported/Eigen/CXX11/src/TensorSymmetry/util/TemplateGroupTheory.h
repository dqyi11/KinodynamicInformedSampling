    ...
    namespace internal
    {
        namespace group_theory
        {
            ...
            struct strip_identities<Equality, id, type_list<t, ts...>>
            {
                typedef typename conditional<
                    ...
                    typename concat<type_list<t>,
                                    typename strip_identities<Equality, id, type_list<ts...>>::type>::type>::type type;
            ...
            /** \internal
              ...
              */
            template <template <typename, typename> class Multiply, template <typename, typename> class Equality,
                      typename id, typename g, typename current_element, typename elements,
                      bool dont_add_current_element  // = false
                      >
            struct dimino_first_step_elements_helper
                : public dimino_first_step_elements_helper<
                      Multiply, Equality, id, g, typename Multiply<current_element, g>::type,
            ...
            /** \internal
              ...
              */
            template <template <typename, typename> class Multiply, template <typename, typename> class Equality,
                      typename id, typename generators>
            struct dimino_first_step_elements
            {
                ...
                typedef dimino_first_step_elements_helper<Multiply, Equality, id, first_generator, first_generator,
                                                          type_list<id>, false> helper;
            ...
            /** \internal
              ...
              */
            template <template <typename, typename> class Multiply, template <typename, typename> class Equality,
                      typename id, typename sub_group_elements, typename elements, typename generators,
                      typename rep_element, int sub_group_size>
            struct dimino_add_cosets_for_rep;

            template <template <typename, typename> class Multiply, template <typename, typename> class Equality,
                      typename id, typename sub_group_elements, typename elements, typename g, typename... gs,
                      typename rep_element, int sub_group_size>
            struct dimino_add_cosets_for_rep<Multiply, Equality, id, sub_group_elements, elements, type_list<g, gs...>,
                                             rep_element, sub_group_size>
            {
                ...
                typedef typename dimino_get_coset_elements<Multiply, sub_group_elements, new_coset_rep, add_coset>::type
                    coset_elements;
                ...
                typedef dimino_add_cosets_for_rep<Multiply, Equality, id, sub_group_elements,
                                                  ...
                                                  rep_element, sub_group_size> _helper;
            ...
            template <template <typename, typename> class Multiply, template <typename, typename> class Equality,
                      typename id, typename sub_group_elements,
                      typename elements EIGEN_TPL_PP_SPEC_HACK_DEFC(typename, empty), typename rep_element,
                      int sub_group_size>
            ...
            struct dimino_add_all_coset_spaces
            {
                ...
                typedef dimino_add_cosets_for_rep<Multiply, Equality, id, sub_group_elements, elements, generators,
                                                  rep_element, sub_group_elements::count> _ac4r;
                ...
                typedef dimino_add_all_coset_spaces<Multiply, Equality, id, sub_group_elements, new_elements,
                                                    generators, sub_group_size, new_rep_pos,
                                                    new_stop_condition> _helper;
            ...
            template <template <typename, typename> class Multiply, template <typename, typename> class Equality,
                      typename id, typename sub_group_elements, typename elements, typename generators,
                      int sub_group_size, int rep_pos>
            struct dimino_add_all_coset_spaces<Multiply, Equality, id, sub_group_elements, elements, generators,
                                               sub_group_size, rep_pos, true>
            {
                typedef elements type;
                constexpr static int global_flags = 0;
            };
            ...
            /** \internal
              ...
              */
            template <template <typename, typename> class Multiply, template <typename, typename> class Equality,
                      typename id, typename elements, typename generators_done, typename current_generator,
            ...
            /** \internal
              ...
              */
            template <template <typename, typename> class Multiply, template <typename, typename> class Equality,
                      typename id, typename generators_done, typename remaining_generators, typename elements>
            struct dimino_add_remaining_generators
            {
                ...
                typedef dimino_add_generator<Multiply, Equality, id, elements, generators_done, first_generator,
                                             _cil::value> _helper;

                typedef typename _helper::type new_elements;

                typedef dimino_add_remaining_generators<
                    Multiply, Equality, id, typename concat<generators_done, type_list<first_generator>>::type,
                    next_generators, new_elements> _next_iter;
            ...
            template <template <typename, typename> class Multiply, template <typename, typename> class Equality,
                      typename id, typename generators_done, typename elements>
            ...
            /** \internal
              ...
              */
            template <template <typename, typename> class Multiply, template <typename, typename> class Equality,
                      typename id, typename generators, int initial_global_flags = 0>
            ...
            template <template <typename, typename> class Multiply, template <typename, typename> class Equality,
                      typename id, int initial_global_flags>
            ...
            /** \internal
              ...
              */
            template <template <typename, typename> class Multiply, template <typename, typename> class Equality,
                      typename id, typename _generators>
