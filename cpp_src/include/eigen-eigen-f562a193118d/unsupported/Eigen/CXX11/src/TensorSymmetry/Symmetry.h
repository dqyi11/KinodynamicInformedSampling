...
namespace Eigen
{
    ...
    namespace internal
    {
        ...
        struct tensor_symmetry_pre_analysis<NumIndices, Gen_, Gens_...>
        {
            ...
            typedef tensor_static_symgroup_if<(sizeof...(Gens_) + 1 <= max_static_generators), NumIndices, Gen_,
                                              Gens_...> helper;
        ...
        struct tensor_symmetry_assign_value
        {
            ...
            static inline int run(const std::array<Index, NumIndices> &transformed_indices, int transformation_flags,
