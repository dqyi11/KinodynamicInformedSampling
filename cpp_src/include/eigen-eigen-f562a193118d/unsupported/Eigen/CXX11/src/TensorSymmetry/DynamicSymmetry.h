...
namespace Eigen
{
    ...
    public:
        ...
        {
            eigen_assert(N >= m_numIndices && "Can only apply symmetry group to "
                                              "objects that have at least the required "
                                              "amount of indices.");
        ...
        {
            eigen_assert(idx.size() >= m_numIndices && "Can only apply symmetry group to objects that have at least "
