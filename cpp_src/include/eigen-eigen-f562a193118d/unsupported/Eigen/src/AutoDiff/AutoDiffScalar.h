...
namespace Eigen
{
    ...
    public:
        typedef internal::auto_diff_special_op<
            ...
            !internal::is_same<typename internal::traits<typename internal::remove_all<_DerType>::type>::Scalar,
                               typename NumTraits<typename internal::traits<
                                   typename internal::remove_all<_DerType>::type>::Scalar>::Real>::value> Base;
    ...
    namespace internal
    {
        ...
        //                            NumTraits<Scalar>::Real>::value>
        {
            ...
            inline const AutoDiffScalar<
                typename CwiseUnaryOp<bind2nd_op<scalar_product_op<Scalar, Real>>, DerType>::Type>
            operator*(const Real &other) const
            {
...
#define EIGEN_AUTODIFF_DECLARE_GLOBAL_UNARY(FUNC, CODE)                                                                \
    ...
    {                                                                                                                  \
        ...
        EIGEN_UNUSED typedef                                                                                           \
            typename Eigen::internal::traits<typename Eigen::internal::remove_all<DerType>::type>::Scalar Scalar;      \
        CODE;                                                                                                          \
    }
    ...
    EIGEN_AUTODIFF_DECLARE_GLOBAL_UNARY(tanh, using std::cosh; using std::tanh; return Eigen::MakeAutoDiffScalar(
                                            tanh(x.value()),
