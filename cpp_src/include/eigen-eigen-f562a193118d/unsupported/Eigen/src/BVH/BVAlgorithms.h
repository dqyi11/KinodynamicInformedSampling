...
namespace Eigen
{
    ...
    namespace internal
    {
                                                   ...
                                                   typename Minimizer::Scalar minimum)
        {
            ...
            std::priority_queue<QueueElement, std::vector<QueueElement>,
                                std::greater<QueueElement>> todo;  // smallest is at the top
    ...
    typename Minimizer::Scalar BVMinimize(const BVH1 &tree1, const BVH2 &tree2, Minimizer &minimizer)
    {
        ...
        typedef typename BVH1::Index Index1;
        typedef typename BVH2::Index Index2;
        typedef internal::minimizer_helper1<typename BVH1::Volume, typename BVH1::Object, typename BVH2::Object,
                                            Minimizer> Helper1;
        typedef internal::minimizer_helper2<typename BVH2::Volume, typename BVH2::Object, typename BVH1::Object,
                                            Minimizer> Helper2;
