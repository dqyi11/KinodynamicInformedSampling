...
namespace Eigen
{
    ...
    protected:
        ...
        int dgmresCycle(const MatrixType &mat, const Preconditioner &precond, Dest &x, DenseVector &r0,
                        RealScalar &beta, const RealScalar &normRhs, int &nbIts) const;
                                                                         ...
                                                                         StorageIndex &neig) const
    {
        ...
        typename internal::conditional<NumTraits<Scalar>::IsComplex, ComplexSchur<DenseMatrix>,
