        ...
        struct kiss_cpx_fft
        {
            ...
            inline void bfly4(Complex *Fout, const size_t fstride, const size_t m)
            {
                ...
                for (size_t k = 0; k < m; ++k)
                {
                    ...
                    scratch[4] =
                        Complex(scratch[4].imag() * negative_if_inverse, -scratch[4].real() * negative_if_inverse);
            ...
            inline void bfly5(Complex *Fout, const size_t fstride, const size_t m)
            {
                ...
                for (u = 0; u < m; ++u)
                {
                    ...
                    *Fout0 += scratch[8];
                    ...
                    scratch[5] =
                        scratch[0] + Complex((scratch[7].real() * ya.real()) + (scratch[8].real() * yb.real()),
                    ...
                    *Fout4 = scratch[5] + scratch[6];
                    ...
                    scratch[11] =
                        scratch[0] + Complex((scratch[7].real() * yb.real()) + (scratch[8].real() * ya.real()),
