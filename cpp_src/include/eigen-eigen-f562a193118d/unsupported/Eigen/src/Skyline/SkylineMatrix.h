    ...
    public:
        ...
        void resize(size_t rows, size_t cols)
        {
            ...
            {  // diagSize is odd
                ...
                m_data.resize(diagSize, IsRowMajor ? cols : rows, IsRowMajor ? rows : cols, 2 * k * k + k + 1,
                              2 * k * k + k + 1);
            }
        ...
        inline SkylineMatrix() : m_outerSize(-1), m_innerSize(0), m_colStartIndex(0), m_rowStartIndex(0)
        {
            resize(0, 0);
        }
