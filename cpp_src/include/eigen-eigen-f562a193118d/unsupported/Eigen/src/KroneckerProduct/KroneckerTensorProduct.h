...
namespace Eigen
{
    ...
    namespace internal
    {
        ...
        struct traits<KroneckerProduct<_Lhs, _Rhs>>
        {
            ...
            typedef
                typename promote_index_type<typename Lhs::StorageIndex, typename Rhs::StorageIndex>::type StorageIndex;
        ...
        struct traits<KroneckerProductSparse<_Lhs, _Rhs>>
        {
            ...
            enum
            {
                ...
                RowsAtCompileTime =
                    size_at_compile_time<traits<Lhs>::RowsAtCompileTime, traits<Rhs>::RowsAtCompileTime>::ret,
                ColsAtCompileTime =
                    size_at_compile_time<traits<Lhs>::ColsAtCompileTime, traits<Rhs>::ColsAtCompileTime>::ret,
