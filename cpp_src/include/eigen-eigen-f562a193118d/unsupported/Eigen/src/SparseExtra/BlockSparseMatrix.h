...
namespace Eigen
{
    /** \ingroup SparseCore_Module
      ...
      */
    template <typename _Scalar, int _BlockAtCompileTime = Dynamic, int _Options = ColMajor,
              typename _StorageIndex = int>
    class BlockSparseMatrix;
    ...
    namespace internal
    {
        ...
        {
            typedef Ref<Matrix<typename BlockSparseMatrixT::Scalar, BlockSparseMatrixT::BlockSize,
                               BlockSparseMatrixT::BlockSize>> Scalar;
            typedef Ref<Matrix<typename BlockSparseMatrixT::RealScalar, BlockSparseMatrixT::BlockSize,
    ...
    public:
        ...
        typedef typename internal::ref_selector<
            BlockSparseMatrix<_Scalar, _BlockAtCompileTime, _Options, _StorageIndex>>::type Nested;
        ...
        typedef Matrix < Scalar, _BlockAtCompileTime, _BlockAtCompileTime,
            IsColMajor ? ColMajor : RowMajor > BlockScalar;
        typedef Matrix < RealScalar, _BlockAtCompileTime, _BlockAtCompileTime,
            IsColMajor ? ColMajor : RowMajor > BlockRealScalar;
        typedef typename internal::conditional<_BlockAtCompileTime == Dynamic, Scalar, BlockScalar>::type
    ...
    public:
        ...
        {
            eigen_assert((m_innerBSize != 0 && m_outerBSize != 0) && "Trying to assign to a zero-size matrix, call "
                                                                     "resize() first");
        ...
        {
            eigen_assert((m_innerBSize != 0 && m_outerBSize != 0) && "TRYING TO RESERVE ZERO-SIZE MATRICES, CALL "
                                                                     "resize() first");
