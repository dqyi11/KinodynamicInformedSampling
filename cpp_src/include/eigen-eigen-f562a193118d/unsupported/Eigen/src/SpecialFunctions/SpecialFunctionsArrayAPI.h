...
namespace Eigen
{
    ...
    inline const Eigen::CwiseBinaryOp<Eigen::internal::scalar_igamma_op<typename Derived::Scalar>, const Derived,
    ...
    /** \cpp11 \returns an expression of the coefficient-wise igammac(\a a, \a x) to
      ...
      */
    template <typename Derived, typename ExponentDerived>
    inline const Eigen::CwiseBinaryOp<Eigen::internal::scalar_igammac_op<typename Derived::Scalar>, const Derived,
                                      const ExponentDerived>
    ...
    inline const Eigen::CwiseBinaryOp<Eigen::internal::scalar_polygamma_op<typename DerivedX::Scalar>, const DerivedN,
                                      const DerivedX>
            ...
            const Eigen::ArrayBase<ArgXDerived> &x)
    {
        return Eigen::CwiseTernaryOp<Eigen::internal::scalar_betainc_op<typename ArgXDerived::Scalar>,
                                     const ArgADerived, const ArgBDerived, const ArgXDerived>(a.derived(), b.derived(),
                                                                                              x.derived());
    }
    ...
    inline const Eigen::CwiseBinaryOp<Eigen::internal::scalar_zeta_op<typename DerivedX::Scalar>, const DerivedX,
                                      const DerivedQ>
