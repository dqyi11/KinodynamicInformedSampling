...
namespace Eigen
{
    ...
    public:
        ...
        ArpackGeneralizedSelfAdjointEigenSolver(const MatrixType &A, Index nbrEigenvalues,
                                                std::string eigs_sigma = "LM", int options = ComputeEigenvectors,
                                                RealScalar tol = 0.0)
          : m_eivec()
          , m_eivalues()
                                                                                       ...
                                                                                       int options, RealScalar tol)
    {
        ...
        do
        {
            internal::arpack_wrapper<Scalar, RealScalar>::saupd(&ido, bmat, &n, whch, &nev, &tol, resid, &ncv, v, &ldv,
    ...
    extern "C" void dseupd_(int *rvec, char *All, int *select, double *d, double *z, int *ldz, double *sigma,
    ...
    namespace internal
    {
        ...
        struct arpack_wrapper
        {
            static inline void saupd(int *ido, char *bmat, int *n, char *which, int *nev, RealScalar *tol,
                                     Scalar *resid, int *ncv, Scalar *v, int *ldv, int *iparam, int *ipntr,
                                     Scalar *workd, Scalar *workl, int *lworkl, int *info)
            {
                EIGEN_STATIC_ASSERT(!NumTraits<Scalar>::IsComplex, NUMERIC_TYPE_MUST_BE_REAL)
            }

            static inline void seupd(int *rvec, char *All, int *select, Scalar *d, Scalar *z, int *ldz,
                                     RealScalar *sigma, char *bmat, int *n, char *which, int *nev, RealScalar *tol,
                                     Scalar *resid, int *ncv, Scalar *v, int *ldv, int *iparam, int *ipntr,
                                     Scalar *workd, Scalar *workl, int *lworkl, int *ierr)
            {
                EIGEN_STATIC_ASSERT(!NumTraits<Scalar>::IsComplex, NUMERIC_TYPE_MUST_BE_REAL)
            }
        };
        ...
        {
            static inline void saupd(int *ido, char *bmat, int *n, char *which, int *nev, float *tol, float *resid,
            ...
            static inline void seupd(int *rvec, char *All, int *select, float *d, float *z, int *ldz, float *sigma,
                                     char *bmat, int *n, char *which, int *nev, float *tol, float *resid, int *ncv,
                                     float *v, int *ldv, int *iparam, int *ipntr, float *workd, float *workl,
                                     int *lworkl, int *ierr)
            {
        ...
        {
            static inline void saupd(int *ido, char *bmat, int *n, char *which, int *nev, double *tol, double *resid,
