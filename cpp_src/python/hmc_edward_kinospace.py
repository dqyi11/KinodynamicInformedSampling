...
hmc_start = np.reshape(results[-1,:-1], (1, no_dimensions))
print("Shape of HMC start: {}".format(hmc_start.shape))
inference = ed.HMC({'z' : qz}, data={x : hmc_start}, model_wrapper=model)
